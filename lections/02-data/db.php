...
$mysql = new mysqli($host, 'root', 'root', 'test', 3306);
...
$ret = $mysql->query("INSERT INTO users (`name`, email, `password`) VALUES ('Jack', 'jack@mail.ru', '$password');");
...
$ret = $mysql->query("UPDATE users SET email = 'ololo@mail.ru' WHERE id > 5");
